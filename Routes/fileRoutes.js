...
const { getUserResearchPapers, handleUpdateUser, handleUserDetails } = require('../Controllers/user');
const fs = require('fs');
...
//Fetch user details
router.get('/user/details', restrictToLoggedInUserOnly, handleUserDetails);
